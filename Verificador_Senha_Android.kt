...
class MainActivity : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val verSenhas = findViewById<EditText>(R.id.editTextTextPassword)
        ...
        botaoValidar.setOnClickListener {
            ...
            val senhaUm = verSenhas.text.toString();

            if(senhaUm.isNotEmpty()){

                if(senhaUm == inputSenhas){

                    resultado.setText("Senha correta!")
